...
#im_tile_resize = cv2.resize(im_tile_resize, (3540, 3440), interpolation = cv2.INTER_AREA)


img9C = cv2.copyMakeBorder(im_tile_resize, 80, 80, 80, 80, cv2.BORDER_CONSTANT, None, [255,255,255])


print("Collage of 3 image Printed")


cv2.imshow('ver', img9C)

cv2.imwrite('/Volumes/Untitled/Habilelabs_projects/Memorizz AI Collage Project/Final Programs/Final useful Collage/Collage of 3 image.JPG', img9C)
