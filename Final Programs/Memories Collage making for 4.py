...
#im_tile_resize = cv2.resize(im_tile_resize, (5840, 4180), interpolation = cv2.INTER_AREA)


img9C = cv2.copyMakeBorder(im_tile_resize, 80, 80, 80, 80, cv2.BORDER_CONSTANT, None, [255,255,255])


print("Collage of 4 image Printed")

cv2.imshow('ver', img9C)

cv2.imwrite('/Volumes/Untitled/Habilelabs_projects/Memories Multiple programs/Final Programs to make collages/Final Programs to save collages/Final useful collage/Collage of 4 image.JPG', img9C)
