...
#img9C = cv2.resize(im_tile_resize, (8760, 4080), interpolation = cv2.INTER_AREA)
...
print("Collage of 5 image Printed")

cv2.imshow('ver', img9C)

cv2.imwrite('/Volumes/Untitled/Habilelabs_projects/Memorizz AI Collage Project/Final Programs/Final useful Collage/Collage of 5 image.JPG', img9C)
