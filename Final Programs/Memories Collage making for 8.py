...
img7 = cv2.imread(hor_path + '1' + file_type) 
img8 = cv2.imread(hor_path + '2' + file_type)
...
print("Collage of 8 image Printed")


cv2.imshow('ver', img9C)

cv2.imwrite('/Volumes/Untitled/Habilelabs_projects/Memorizz AI Collage Project/Final Programs/Final useful Collage/Collage of 8 image.JPG', img9C)
