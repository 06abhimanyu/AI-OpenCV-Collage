...
img7 = cv2.imread(path + '7' + file_type)
img8 = cv2.imread(path + '8' + file_type)
img9 = cv2.imread(path + '9' + file_type)
...
print("Collage of 9 image Printed")

cv2.imshow('ver', img9C)

cv2.imwrite('/Volumes/Untitled/Habilelabs_projects/Memorizz AI Collage Project/Final Programs/Final useful Collage/Collage of 9 image.JPG', img9C)
