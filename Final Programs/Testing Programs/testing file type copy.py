...
for file in files:
    ...
    if file == ("0.5_ver_img_1.JPG") or file == ("0.5_ver_img_2.JPG") or file == ("0.5_ver_img_3.JPG") or file == ("0.5_ver_img_4.JPG")or file == ("0.5_ver_img_5.JPG") or file == ("0.5_ver_img_6.JPG") or file == ("0.5_ver_img_7.JPG") or file == ("0.5_ver_img_8.JPG") or file == ("0.5_ver_img_9.JPG"):
        print(file)
        img = cv2.imread(file)
        #cv2.imshow("img", img)
        #cv2.waitKey()

    elif file == ("0.8_ver_img_1.JPG") or file == ("0.8_ver_img_2.JPG") or file == ("0.8_ver_img_3.JPG") or file == ("0.8_ver_img_4.JPG")or file == ("0.8_ver_img_5.JPG") or file == ("0.8_ver_img_6.JPG") or file == ("0.8_ver_img_7.JPG") or file == ("0.8_ver_img_8.JPG") or file == ("0.8_ver_img_9.JPG"):
        print(file)
        img = cv2.imread(file)
        #cv2.imshow("img", img)
        #cv2.waitKey()
    ...
    elif file == ("1.2_hor_img_1.JPG") or file == ("1.2_hor_img_2.JPG") or file == ("1.2_hor_img_3.JPG") or file == ("1.2_hor_img_4.JPG")or file == ("1.2_hor_img_5.JPG") or file == ("1.2_hor_img_6.JPG") or file == ("1.2_hor_img_7.JPG") or file == ("1.2_hor_img_8.JPG") or file == ("1.2_hor_img_9.JPG"):
        print(file)
        img = cv2.imread(file)
        cv2.imshow("img", img)
        cv2.waitKey()
